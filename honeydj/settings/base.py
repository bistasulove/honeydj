...
# Load .env when present (local dev). In production, env vars are injected directly.
...
MIDDLEWARE = [
    ...
    "apps.honeypot.middleware.HoneyMiddleware",
...
WSGI_APPLICATION = "honeydj.wsgi.application"
ASGI_APPLICATION = "honeydj.asgi.application"
...
CELERY_TASK_ROUTES = {
    "apps.events.tasks.*": {"queue": "enrichment"},
